    ...
    return (
        <motion.div
            ...
            <div className="w-full flex items-center justify-between p-4 cursor-pointer">
                ...
                <p whileTap={{ scale: 0.75 }} className='text-textColor text-lg font-semibold'>Cart</p>
                <motion.p className='flex items-center gap-2 p-1 px-2 my-2 bg-gray-100 rounded-md hover:shadow-md  cursor-pointer text-textColor text-base'>Clear <RiRefreshFill />{" "}</motion.p>
            </div>
            ...
            {cartItems && cartItems.length > 0 ? (
                <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
                    ...
                    <div className='w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2'>
                        ...
                        <div className='w-full border-b border-gray-600 my-2'></div>{/* divider margin line */}
